...
public class SantanderLogin extends BaseSeleniumPage {
    ...
    public static final String PASSWORD_SUBMIT_XPATH =
            "//*[@id=\"formAuthenticationAbbey\"]/div[2]/span[1]/input";

    /** The Constant PASSWORD_VALUE_XPATH. */
    public static final String PASSWORD_VALUE_XPATH =
            "//*[@id=\"passwordPosition";
    ...
    public static final String ANSWER_SUBMIT_XPATH =
            "//*[@id=\"formCustomerID\"]/div/span[1]/input";

    /** The Constant CUSTOMER_ID_SUBMIT_XPATH. */
    public static final String CUSTOMER_ID_SUBMIT_XPATH =
            "//*[@id=\"formCustomerID_1\"]/fieldset/div/div/span/input";

    /** The Constant CUSTOMER_ID_XPATH. */
    public static final String CUSTOMER_ID_XPATH =
            "//*[@id=\"infoLDAP_E.customerID\"]";

    /** The Constant answerxpath. */
    public static final String ANSWER_XPATH =
            "//*[@id=\"cbQuestionChallenge.responseUser\"]";

    /**
     * The Constant
     * IN_WHAT_CITY_OR_TOWN_WERE_YOU_MARRIED_ENTER_FULL_NAME_OF_CITY_OR_TOWN.
     */
    private static final String IN_WHAT_CITY_OR_TOWN_WERE_YOU_MARRIED =
            "In what city or town were you married? (Enter full name of city or town)";

    /**
     * The Constant
     * IN_WHAT_CITY_OR_TOWN_WERE_YOU_BORN_ENTER_FULL_NAME_OF_CITY_OR_TOWN_ONLY.
     */
    public static final String IN_WHAT_CITY_OR_TOWN_WERE_YOU_BORN =
            "In what city or town were you born? (Enter full name of city or town only)";
     ...
     * .
     */
    private static final String IN_WHAT_CITY_OR_TOWN_WAS_YOUR_FATHER_BORN =
            "In what city or town was your father born? (Enter full name of city or town only)";

    /** The Constant WHAT_IS_YOUR_FATHER_S_MIDDLE_NAME. */
    public static final String WHAT_IS_YOUR_FATHER_S_MIDDLE_NAME =
            "What is your father´s middle name?";

    /** The Constant WHAT_WAS_THE_NAME_OF_YOUR_FIRST_PET. */
    public static final String WHAT_WAS_THE_NAME_OF_YOUR_FIRST_PET =
     ...
     * .
     */
    public static final String NAME_OF_YOUR_LAST_SCHOOL =
            "What was the name of your last school? "
                    + "(Enter only \"Thingwall\" for Thingwall infant School)";

    /** The Constant WHAT_IS_YOUR_FAVOURITE_FOOTBALL_TEAM. */
    public static final String WHAT_IS_YOUR_FAVOURITE_FOOTBALL_TEAM =
     ...
     * .
     */
    public static final String WHERE_DID_YOU_MEET_YOUR_SPOUSE =
    ...
    public static final String NAME_OF_CHIEF_BRIDESMAID =
            "What is the first name of the maid of honour "
                    + "or chief bridesmaid at your wedding?";

    /** The Constant questionXpath. */
    public static final String QUESTION_XPATH =
            "//*[@id=\"formCustomerID\"]/fieldset/div/div[1]/span[2]";
    ...
    private static final String SECURITY_ID_POSITION_PREFIX =
            "passwordPosition";

    /** The Constant SECURITY_ID_INDEX_PREFIX. */
    private static final String SECURITY_ID_INDEX_PREFIX =
            "//*[@id=\"formAuthenticationAbbey\"]/div[1]/div[2]/span[2]/span/span[1]/label[";
    ...
    private final Question[] filterQuestions =
            new Question[] {
                    new Question("bridesmaid",
                            SantanderLogin.NAME_OF_CHIEF_BRIDESMAID),
                    new Question("football",
                            SantanderLogin.WHAT_IS_YOUR_FAVOURITE_FOOTBALL_TEAM),
                    new Question("spouse",
                            SantanderLogin.WHERE_DID_YOU_MEET_YOUR_SPOUSE),
                    new Question("school",
                            SantanderLogin.NAME_OF_YOUR_LAST_SCHOOL),
                    new Question("pet",
                            SantanderLogin.WHAT_WAS_THE_NAME_OF_YOUR_FIRST_PET),
                    new Question("fathermiddle",
                            SantanderLogin.WHAT_IS_YOUR_FATHER_S_MIDDLE_NAME),
                    new Question(
                            "fatherborn",
                            SantanderLogin.IN_WHAT_CITY_OR_TOWN_WAS_YOUR_FATHER_BORN),
                    new Question("born",
                            SantanderLogin.IN_WHAT_CITY_OR_TOWN_WERE_YOU_BORN),
                    new Question(
                            "citymarried",
                            SantanderLogin.IN_WHAT_CITY_OR_TOWN_WERE_YOU_MARRIED)
            };
    ...
    public SantanderLogin(final WebDriver webDriver, final Config config) {
        super(webDriver, config
                .getProperty("bookkeeper.web.santander.url.accounts"));
        this.loginUrl =
                config.getProperty("bookkeeper.web.santander.url.start");
        ...
        this.securityNumber =
                config.getProperty("bookkeeper.web.santander.securitynumber");
        this.questions = new HashMap<>();
        final String questionPrefix = "bookkeeper.web.santander.question.";
        for (final Question question : this.filterQuestions) {
            this.questions.put(
                    question.configKeyString,
                    config.getProperty(questionPrefix
                                       + question.configKeyString));
            SantanderLogin.LOGGER.info("Q: "
                                       + question.configKeyString
                                       + " - "
                                       + this.questions
                                               .get(question.configKeyString));
    ...
    public static void main(String[] args) throws Exception {
        ...
        final SantanderDownloadTransactions santanderLogin =
                new SantanderDownloadTransactions(new SantanderLogin(webDriver,
                        config));
        santanderLogin.get();
    ...
    private void enterCustomerId() {
        this.enterValueIntoField(this.customerId,
                SantanderLogin.CUSTOMER_ID_XPATH);
    ...
    private void filterQuestion() {
        List<WebElement> questopnList =
                this.getWebDriver().findElements(
                        By.xpath(SantanderLogin.QUESTION_XPATH));
    ...
    protected final void load() {
        ...
        try {
            ...
            SantanderLogin.LOGGER
                    .info("No filter screen. Ignore and try next page");
        }
        this.passwordPage();

        try {
            WebElement popup =
                    this.findElementByXpath("//*[@id=\"PopUp\"]/div/form/fieldset/div/span/a");
            if (null != popup) {
                popup.click();
            }
        }
    ...
    private void enterSecurityNumber() {
        String signPositionPrefix = SantanderLogin.SECURITY_ID_POSITION_PREFIX;
        String prefix = SantanderLogin.SECURITY_ID_INDEX_PREFIX;
        enterCharacters(signPositionPrefix, prefix, this.securityNumber);
    }
    ...
    private void enterPassword() {
        String signPositionPrefix = SantanderLogin.SIGN_POSITION_PREFIX;
        String prefix = SantanderLogin.PASSWORD_INDEX_XPATH;
        enterCharacters(signPositionPrefix, prefix, this.password);
    }
    ...
    private void enterCharacters(
        ...
        enterCode(1, nodes[0], prefix, keyword);
        enterCode(2, nodes[1], prefix, keyword);
        enterCode(lastDigit, nodes[2], prefix, keyword);
    }
}
