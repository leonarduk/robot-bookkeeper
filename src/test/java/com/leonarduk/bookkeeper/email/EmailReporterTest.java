...
//		transactions.add(new TransactionRecord(12.23, "deposit", new Date(2016, 3, 3), "12", "work"));
...
//		Assert.assertEquals("<html><body><h1>Todays Transactions</h1>eggs", this.reporter.getChanges().toString());
//	}
//
//	@Test
...
//		Assert.assertEquals("<html><body><h1>Todays Transactions</h1><html><body><h1>Todays Transactions</h1>",
//				this.reporter.getChanges().toString());
//	}
//
//}
